...
import { ActionEnginePage } from "./pages/ActionEngine/ActionEngine";
import { ImpactAnalysisPage } from "./pages/ImpactAnalysis/ImpactAnalysis";
...
export function App(props: Props) {
    ...
    useEffect(() => {
        (async () => {
            const currentOcel = localStorage.getItem("proact-currentOcel");
    ...
    const loadSessionOrStartNewOne = async (newOcel: string) => {
        ...
        localStorage.setItem("proact-currentOcel", newOcel);
        autosaveEnabled.current = true;
    }
    ...
    function restoreSession(sessionState: SessionState) {
        ...
        localStorage.setItem("proact-currentOcel", sessionState.ocel);
    }
    ...
    return (
        <QueryClientProvider client={queryClient}>
            <Routes>
                ...
                <Route path="/action" element={<ActionEnginePage />}></Route>
                <Route path="/impact" element={<ImpactAnalysisPage />}></Route>
