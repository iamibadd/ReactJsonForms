...
export const SET_CONSTRAINT_GRAPH_STATE = 'SET_CONSTRAINT_GRAPH_STATE'
export const ADD_CONSTRAINT_GRAPH = 'ADD_CONSTRAINT_GRAPH'
export const DELETE_CONSTRAINT_GRAPH = 'DELETE_CONSTRAINT_GRAPH'
export const SET_CONSTRAINT_PATTERN_STATE = 'SET_CONSTRAINT_PATTERN_STATE'
...
export interface SessionState {
    ...
    constraintGraphState: ConstraintGraph[]
    constraintPatternState: ConstraintPattern[]
}
