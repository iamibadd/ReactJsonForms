...
import '../ProActNavbar/NavbarButton/NavbarButton.css';
...
type BackendSession = {
    ...
    constraint_graph_state: ConstraintGraph[],
    constraint_pattern_state: ConstraintPattern[],
}
...
export function UserSession(props: { storeOrRestore: string, userSessionState?: SessionState, stateChangeCallback?: any }) {
    ...
    if (storeOrRestore === "store" && userSessionState) {
        ...
        const data = [
            ...
            { key: "Constraint Graphs", value: userSessionState.constraintGraphState ? JSON.stringify(userSessionState.constraintGraphState) : null },
            { key: "Constraint Graphs", value: userSessionState.constraintPatternState ? JSON.stringify(userSessionState.constraintPatternState) : null },
        ]
        content = (
            <React.Fragment>
...
export async function storeSession(name: string, session: SessionState) {
    ...
    console.log(translateToBackend(session))
    await fetch(uri, {
        method: 'PUT',
        headers: {
...
function translateToFrontend(session: BackendSession): SessionState {
    return {
        ...
        constraintGraphState: session.constraint_graph_state,
        constraintPatternState: session.constraint_pattern_state,
    }
}
